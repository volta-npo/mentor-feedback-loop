export const v3 = {
  "productName": "Mentor Feedback Loop",
  "productTier": "release",
  ...
  "capabilities": [
    "Domain-specific workbench: Mentor Review Loop",
    "Operational table: Feedback comments",
  ...
  "releaseChecklist": [
    ...
    "Resolution Rate reaches production threshold",
    "Actionability is documented with evidence",
    "Mentor Load has no unresolved blocker",
    "Review packet verified",
    "Action item report verified",
    "Growth reflection verified"
  ],
  "operations": [
